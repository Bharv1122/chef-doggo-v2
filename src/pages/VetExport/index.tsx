        ...
        <div className="space-y-6">
          ...
          <section className="border-t border-[#E7E5E4] pt-4">
            <p className="text-xs text-[#78716C] leading-relaxed italic">
              This document was generated by Cheffo Doggo (cheffo.vercel.app), a homemade dog food planning tool. Cheffo Doggo provides general educational guidance and does not replace professional veterinary advice. All calorie estimates, portion sizes, and supplement ranges are educational starting points only. A licensed veterinarian or veterinary nutritionist should review all homemade diets before feeding, especially for puppies, seniors, pregnant/nursing dogs, and dogs with medical conditions.
            </p>
          </section>
        </div>
      </PageWrapper>
