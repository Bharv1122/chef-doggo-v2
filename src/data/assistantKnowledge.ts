...
export const INGREDIENT_SAFETY: IngredientSafetyRecord[] = [
  ...
  { name: 'garlic', aliases: ['garlic powder'], safety: 'toxic', why: 'Same hemolytic mechanism as onion, more concentrated. Even small amounts of garlic powder are unsafe.', guidance: 'Some holistic vets debate small fresh-garlic doses for flea support — Chef Doggo defaults to blocking entirely.' },
